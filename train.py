...
if __name__ == '__main__':
    ...
    if args.continue_from:  # Starting from previous model
        ...
        #input = torch.randn([20, 1, 161, 132])
        #input_sizes = 132 * torch.ones(20)
        #output= model(input,input_sizes)
        #torch.onnx.export(model,(input, input_sizes) , "deepspeech.onnx", verbose=True)
        #exit(0)
